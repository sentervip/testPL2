...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-encoder=aac"
...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-parser=mjpeg4video"
...
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --extra-cflags=-I$EXTERN_PKT_SRC_FAAC/include"
#export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --extra-ldflags=-L$EXTERN_PKT_SRC_FAAC/libfaac/.libs"
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-debug=LEVEL" #quiet, panic, fatal, error, warning, info, verbose , debug
